...
namespace backend.Controllers
{
    ...
    public class CreateController : ControllerBase
    {
        ...
        {
            var AreaID = await _databaseService.ExecuteInsertAsync("INSERT INTO ParkAreas (Name, Theme, Description, ImageUrl, OpeningTime, ClosingTime) VALUES (@Name, @Theme, @Description, @ImageUrl, @OpeningTime, @ClosingTime)",
            ...
            return Ok(new { message = "Area created successfully", AreaID = AreaID });
        }
        ...
        {
            var rideID = await _databaseService.ExecuteInsertAsync("INSERT INTO Rides (ImageUrl, Name, Type, AreaID, MaximumCapacity, MinimumHeight, Duration, UnitPrice, Description, OpeningTime, ClosingTime) VALUES (@ImageUrl, @Name, @Type, @AreaID, @MaximumCapacity, @MinimumHeight, @Duration, @UnitPrice, @Description, @OpeningTime, @ClosingTime)",
            ...
            return Ok(new { message = "Ride created successfully", RideID = rideID });
        }
        ...
        {
            var eventID = await _databaseService.ExecuteInsertAsync("INSERT INTO Events (Name, Description, EventType, AgeRestriction, ImageUrl, StartDate, EndDate, RequireTicket, UnitPrice) VALUES (@Name, @Description, @EventType, @AgeRestriction, @ImageUrl, @StartDate, @EndDate, @RequireTicket, @UnitPrice)",
